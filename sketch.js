...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(camera.position.x + windowWidth/2 > ground.x + ground.windowWidth/2){
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(camera.position.x + windowWidth/2, 300, 40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(camera.position.x + windowWidth/2, windowHeight-40,10,40);
    //obstacle.debug = true;
